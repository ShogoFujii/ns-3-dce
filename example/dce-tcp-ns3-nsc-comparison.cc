...
main (int argc, char *argv[])
{
  ...
  BulkSendHelper bulk = BulkSendHelper (sock_factory,
                                        InetSocketAddress ("10.0.0.2", 2000));
  ...
  //sink.SetAttribute ("MaxBytes", UintegerValue (0));
  ...
  pointToPoint.EnablePcapAll ("./pcap/tcp/dce-tcp-comparison");
  Simulator::Stop (Seconds (stopTime));
  AnimationInterface anim("./xml/tcp.xml");
  Simulator::Run ();
